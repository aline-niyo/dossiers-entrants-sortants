...
<body>
    ...
    <nav class="nav">
        <a href="#">Accueil</a>
        <a href="trans_dossier.php">Dossiers</a>
        <a href="comment.php">Commentaires</a>
        <a href="traitement.php">traitements</a>
        <a href="reponse.php">Reponses</a>
        <!-- <a href="register.php">Register</a> -->
        <a href="utilisateur.php">Utilisateurs</a>
        <a href="destinateur.php">Expediteurs</a>
        <a href="secretaire.php">Secretaires</a>
        <a href="secretaire_interim.php">Secretaire(interim)</a>
        <a href=""></a>
